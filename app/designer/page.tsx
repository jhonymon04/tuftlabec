...
export default function DesignerPage() {
  ...
  const [useBackgroundRemoval, setUseBackgroundRemoval] =
    useState(false);

  const [isProcessing, setIsProcessing] =
    useState(false);

  const [rugColor, setRugColor] =
    useState("#ebdca1");
  ...
  const handleToggleBackground = async (
    ...
    if (
      ...
      try {
        const imageBlob =
          await removeBackground(rawFile);
  ...
  const changeRandomBackground = () => {
    const filtered = roomBackgrounds.filter(
        ...
        >
          ...
          >
            ...
            <button
              ...
              `}
            >
              <ImageIconSolid className="w-3.5 h-3.5" />
              Realista
            </button>
          </div>
                ...
                <img
                  ...
                  style={{
                    filter: `
                      ...
                      drop-shadow(2px -2px 0px ${rugColor})
                      drop-shadow(-2px 2px 0px ${rugColor})
                      drop-shadow(0px 15px 25px rgba(0,0,0,${
                        viewMode ===
                        "blueprint"
                          ? "0.08"
                          : "0.35"
